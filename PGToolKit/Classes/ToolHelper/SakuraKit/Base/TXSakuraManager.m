...
UIKIT_EXTERN NSString *const kTXSakuraArgNaviBarBackgroundImage;
...
+ (NSDictionary *)tx_getObjVectorOperationKV {
    return @{
             kTXSakuraArgNaviBarBackgroundImage:@"tx_imageWithColor:",
...
//uiimage from color
+ (UIImage *)tx_imageWithColor:(NSString *)color
{
    UIColor *tColor = [self tx_colorWithPath:color];
...
// UIImage from NSBundle or Sandbox imageWithGradientTintColor
...
//+ (UIImage *)tx_imageWithPath:(NSString *)path {
//    NSString *imageName = path;
//    UIImage *image = nil;
//    if (imageName && imageName.length) {
//        if (_currentSakuraType == TXSakuraTypeMainBundle) {
//            if ([UIScreen mainScreen].scale == 3.0) {
//                imageName = [path stringByAppendingString:@"@3x.png"];
//            }else {
//                imageName = [path stringByAppendingString:@"@2x.png"];
//            }
//            NSString *name = [TXSakuraManager getSakuraCurrentName];
//            UIColor *color;
//            if ([name isEqualToString:@"DarkTheme"]) {
//                color = [UIColor redColor];
//            }
//            if (color) {
//                image = [[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:imageName ofType:nil]] imageWithGradientTintColor:color];
//            }else {
