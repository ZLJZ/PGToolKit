...
- (void)setAttributesGroup:(NSArray *)attributesGroup {
    _attributesGroup = attributesGroup;
    if (self.onlyDisplayText) {
        NSMutableArray *temp = [NSMutableArray new];
        for (int i = 0; i < _attributesGroup.count; i++) {
            [temp addObject:@""];
        }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else if (_attributesGroup.count && itemIndex < _attributesGroup.count) {
        cell.attributedString = _attributesGroup[itemIndex];
    }
    ...
    if (!cell.hasConfigured) {
        ...
        if (_attributesGroup.count && itemIndex < _attributesGroup.count) {
            cell.attributedString = _attributesGroup[itemIndex];
        }
    }
